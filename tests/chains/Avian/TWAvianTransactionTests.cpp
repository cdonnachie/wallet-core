...
TEST(RavencoinTransaction, SignTransaction) {
    /*
        ...
        m/44'/921'/0'/0/0 Address - RFMdKw9vWPcfpZSUW87mwKP62TUZeF7uwQ
        m/44'/921'/0'/0/0 Private key in Base58 encoding - L3z6qCVMAi5WE38Z3Y1fEwtHKJoMg5LsfvDZPdGu4zuYmNX35oPN
        m/44'/921'/0'/0/0 Private key in bytes - 75e4c520c92b3836e77dfe2715da469b71f7df86fc11ef328870735a700551fa
    ...
    */
    ...
    const int64_t amount = 25000000;
    const int64_t fee = 2000000;

    auto input = Proto::SigningInput();
    input.set_hash_type(TWBitcoinSigHashTypeFork);
    ...
    input.set_coin_type(TWCoinTypeAvian);
...
TEST(AvianTransaction, LockScripts) {
    // P2PKH
    // https://blockbook.ravencoin.org/tx/3717b528eb4925461d9de5a596d2eefe175985740b4fda153255e10135f236a6

    auto script = WRAP(TWBitcoinScript, TWBitcoinScriptLockScriptForAddress(STRING("RNoSGCX8SPFscj8epDaJjqEpuZa2B5in88").get(), TWCoinTypeAvian));
    ...
    auto script2 = WRAP(TWBitcoinScript, TWBitcoinScriptLockScriptForAddress(STRING("rPWwn5h4QFZNaz1XmY39rc73sdYGGDdmq1").get(), TWCoinTypeAvian));
